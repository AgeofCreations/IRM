...
class Mainpage extends React.Component {
    render() {
        return (
            ...
            <p>Особенно стоит остановиться на меню "Команда". Там вы сможете узнать какими правами доступа вы обладаете. И слегка изменить чужие права. Скорее всего, туда я ещё воткну активацию аккаунтов пользователей, которой будут заниматься руководители и администраторы сервиса</p>
